...
import com.inflearn.lecture.spring.api.service.mail.MailService;
import com.inflearn.lecture.spring.domain.order.Order;
import com.inflearn.lecture.spring.domain.order.OrderRepository;
import com.inflearn.lecture.spring.domain.order.OrderStatus;
...
public class OrderStatisticsService {
    ...
    public boolean sendOrderStatisticsMail(LocalDate orderDate, String email) {
        // 해당 일자에 결제완료(PAYMENT_COMPLETE)된 주문들을 가져와서
